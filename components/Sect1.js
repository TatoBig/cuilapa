  ...
  return (
    <>
      ...
      <ul className="list-disc list-inside text-sm mb-4 text-gray-700">
        <li>
          <strong>Aditivo:</strong> EDTA K₂ / K₃ (ácido
          etilendiaminotetraacético)
        </li>
        <li>
          <strong>Uso principal:</strong> Hematología
        </li>
        <li>
          <strong>Presentaciones:</strong> Adulto (4–5 mL) y pediátrico (0.5–2
          mL)
        </li>
        <li>
          <strong>Usos:</strong>
      ...
      <ul className="list-disc list-inside text-sm mb-4 text-gray-700">
        <li>
          <strong>Aditivo:</strong> Citrato de sodio 3.2%
        </li>
        <li>
          <strong>Uso principal:</strong> Pruebas de coagulación
        </li>
        <li>
          <strong>Presentaciones:</strong> Adulto (2.7 mL), Pediátrico (1.8 mL)
        </li>
        <li>
          <strong>Usos:</strong>
          <ul className="list-disc list-inside ml-4">
      ...
      <ul className="list-disc list-inside text-sm mb-4 text-gray-700">
        <li>
          <strong>Aditivo:</strong> Gel separador + activador de coagulación
        </li>
        <li>
          <strong>Uso principal:</strong> Química clínica e inmunología
        </li>
        <li>
          <strong>Adulto:</strong> Tapa amarilla (2.7 mL).{" "}
          <strong>Pediátrico:</strong> Tapa roja (1.8 mL)
        </li>
        <li>
          <strong>Perfiles:</strong>
          <ul className="list-disc list-inside ml-4">
            <li>
              <strong>Hepático:</strong> AST, ALT, Bilirrubinas, FA, GGT
            </li>
            <li>
              <strong>Renal:</strong> Urea, Creatinina, Ácido úrico
            </li>
            <li>
              <strong>Lipídico:</strong> Colesterol total, HDL, LDL,
              Triglicéridos
            </li>
            <li>
              <strong>Endocrino:</strong> TSH, T3, T4
            </li>
            <li>
              <strong>Cardíaco:</strong> Troponinas, CK-MB, LDH
            </li>
            <li>
              <strong>Electrolitos:</strong> Na⁺, K⁺, Cl⁻, Ca, P, Mg
            </li>
            <li>
              <strong>Marcadores tumorales:</strong> PSA, AFP, CA 125, 15-3,
              19-9, CEA
            </li>
            <li>
              <strong>Inmunología:</strong> Ferritina, IL-6, anti-HBs, VIH,
              VDRL, etc.
            </li>
            <li>
              <strong>Autoinmunes:</strong> ANA, Anti-TPO, Anti-CCP, FR, ASO
            </li>
            <li>
              <strong>Serología:</strong> Toxoplasma, Rubéola, CMV, HSV (IgG /
              IgM)
            </li>
          </ul>
        </li>
        <li className="text-yellow-700">
          ⚠️ En pediatría se usa tubo rojo (sin gel) por menor volumen
          requerido.
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside text-sm mb-4 text-gray-700">
        <li>
          <strong>Aditivo:</strong> Ninguno (tubo seco)
        </li>
        <li>
          <strong>Uso principal:</strong> Suero sin interferencia (líquidos
          biológicos, banco de sangre)
        </li>
        <li>
          <strong>Volumen:</strong> 5 mL
        </li>
        <li>
          ...
          <tbody className="divide-y divide-gray-200">
            ...
            <tr>
              ...
              <td className="px-4 py-2">
                Suero (tras coagulación y centrifugación)
              </td>
              <td className="px-4 py-2">
                Suero (tras coagulación y centrifugación)
              </td>
            ...
            <tr>
              ...
              <td className="px-4 py-2">
                Líquidos biológicos / banco de sangre
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="px-4 py-2">
                Facilita separación de suero con gel
              </td>
              <td className="px-4 py-2">
                Sin aditivo ni gel; separación manual
              </td>
            </tr>
          </tbody>
        </table>
